      ...
      <div className="space-y-8">
        <div className="card">
          ...
          <p className="text-gray-600 leading-relaxed">
            这是一个现代化的 React 项目模板，集成了最新的前端开发工具和最佳实践。
        ...
        <div className="card">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-4">
              <code className="bg-gray-100 px-2 py-1 rounded">npm run lint</code>
              <span className="text-gray-600">代码检查</span>
            </div>
            <div className="flex items-center space-x-4">
              <code className="bg-gray-100 px-2 py-1 rounded">npm run preview</code>
